...
const AdminLayout: React.FunctionComponent<LayoutProps> = ({ children }) => {
    ...
    const handleClick = (item: LinkMenu) => {
        ...
        const element = document.querySelector('div[drawer-backdrop]')
        if(element){
    ...
    return (
        <div className={inter.className}>
            <button onClick={() => document.getElementById("default-sidebar")?.classList.remove("-translate-x-full")} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
