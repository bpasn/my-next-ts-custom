...
export const ButtonFormSubmit = styled(MuiButton)({
    color: '#fff !important',
    backgroundImage: 'linear-gradient(to right,#f78ca0 0,#f9748f 19%,#fd868c 60%,#fe9a8b 100%) !important',
    backgroundColor: '#fe9a8b !important',
    ...
    touchAction: 'manipulation',
    cursor: 'pointer ',
    boxShadow: '0 5px 20px 0 rgba(0,0,0,.1) !important',
    willChange: 'opacity,transform !important',
    transition: 'all .3s ease-out !important',
    webkitTransition: 'all .3s ease-out !important',
    textAlign: "center",
    width: "100% !important",
    ...
    '& :hover': {
        ...
        boxShadow: '0 5px 20px 0 rgba(0,0,0,.3) !important',
    },
